...
var lValueNames = [...]string{"nil", "boolean", "float", "int", "string", "function", "userdata", "thread", "table", "channel"}
...
type LValue interface {
	String() string
	Type() LValueType
	// to reduce `runtime.assertI2T2` costs, these methods should be used instead of the type assertion in heavy paths(typically inside the VM).
...
func (bl LBool) assertInt64() (int64, bool)         { return 0, true }
...
func (nm LString) assertInt64() (int64, bool)         { return 0, true }
...
func (nm LInt) String() string                     { return fmt.Sprint(int64(nm)) }
func (nm LInt) Type() LValueType                   { return LTInt }
func (nm LInt) assertFloat64() (float64, bool)     { return float64(nm), true }
func (nm LInt) assertInt64() (int64, bool)         { return int64(nm), true }
func (nm LInt) assertString() (string, bool)       { return "", false }
func (nm LInt) assertFunction() (*LFunction, bool) { return nil, false }

// fmt.Formatter interface
func (nm LInt) Format(f fmt.State, c rune) {
	switch c {
	case 'q', 's':
...
func (nm LFloat) String() string                     { return fmt.Sprint(float64(nm)) }
func (nm LFloat) Type() LValueType                   { return LTFloat }
func (nm LFloat) assertFloat64() (float64, bool)     { return float64(nm), true }
func (nm LFloat) assertInt64() (int64, bool)         { return int64(nm), true }
func (nm LFloat) assertString() (string, bool)       { return "", false }
func (nm LFloat) assertFunction() (*LFunction, bool) { return nil, false }

// fmt.Formatter interface
func (nm LFloat) Format(f fmt.State, c rune) {
	switch c {
	case 'q', 's':
		defaultFormat(nm.String(), f, c)
	case 'b', 'c', 'd', 'o', 'x', 'X', 'U':
